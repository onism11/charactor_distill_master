---
name: workflow-stage-fg-audit
description: Internal F/G-stage audit document for the full workflow. Use after trace, distill, theme, and route outputs are available.
---

# Workflow Stage F/G: Audit and Test
